...
parser.add_argument('--model_path', type=str, default="bge-m3", help='Path to the model')

parser.add_argument('--output_path', type=str, default="./retrivers_res/bge-m3.json", help='Path to output json')
...
def find_top_k_similar(texts, query,index_ls, k=50, batch_size=8):
