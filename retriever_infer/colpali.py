...
# from colpali_engine_ocr.models import ColQwen2_5,ColQwen2_5_proj2_512, ColQwen2_5Processor
...
parser.add_argument('--model_path', type=str, default="colpali", help='Path to the model')

parser.add_argument('--output_path', type=str, default="./retrivers_res/colpali.json", help='Path to output json')
