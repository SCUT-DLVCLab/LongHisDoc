...
parser.add_argument('--model_path', type=str, default="colsmolvlm", help='Path to the model')

parser.add_argument('--output_path', type=str, default="./retrivers_res/colsmolvlm.json", help='Path to output json')
